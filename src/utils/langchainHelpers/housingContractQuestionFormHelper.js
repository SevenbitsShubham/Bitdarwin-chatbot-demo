...
const schema={
    ...
    properties:{
        ...
        closingDateForContractItShouldBeInYYdashMMdashDDFormat:{type:"string",description:"This is the date at which contract validity will expire to create the housing contract.."}, 
